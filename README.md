# JamesBondBot
A Twitter bot ([@JamesBondBot](https://twitter.com/JamesBondBot) - inactive at the moment) that likes the most recent tweet with hashtags related to James Bond, such as #JamesBond and #007. A Node.js web app running on a Raspberry Pi 3.
